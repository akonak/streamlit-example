...
df = pd.read_csv('/Users/auk3/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Documents/Research/Proposals/BelmontProposal/DSS/indicator.csv', header=0, index_col='no')
df2 = pd.read_csv('/Users/auk3/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Documents/Research/Proposals/BelmontProposal/DSS/SurveyResultWeights.csv', index_col = 0)
adf = pd.read_csv('/Users/auk3/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Documents/Research/Proposals/BelmontProposal/DSS/AdaptiveIndicators.csv', header=0,index_col = 'no')
cdf = pd.read_csv('/Users/auk3/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Documents/Research/Proposals/BelmontProposal/DSS/CopingIndicators.csv', header=0, index_col = 'no')
